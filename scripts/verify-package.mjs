...
if (leakedPlaygroundFiles.length > 0) throw new Error(`Playground files leaked into the root package: ${leakedPlaygroundFiles.join(', ')}`);
...
if (forbiddenFiles.length > 0) {
  ...
  for (const path of forbiddenFiles) console.error(`- ${path}`);
  process.exit(1);
}
